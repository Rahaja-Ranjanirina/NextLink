...
<head>
    <meta charset="UTF-8">
    <title>NextLink - Identifiants Enseignant</title>
</head>
<body style="font-family: Arial, sans-serif; background-color:#04081a; color:#fff; padding:20px;">
    <div style="max-width:600px; margin:auto; background: rgba(0,0,0,0.7); padding:30px; border-radius:15px;">
        <h2 style="color:#00d2ff;">Bonjour {{ $enseignant->prenom }} {{ $enseignant->name }}</h2>
        <p>Votre compte enseignant NextLink a été créé avec succès.</p>
