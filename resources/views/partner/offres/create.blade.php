...
<style>
    /* ========================================
       PARTNER OFFRE CREATE - PREMIUM DESIGN
...
<div class="create-container">
    ...
    <div class="create-content animate-fade-up">
        ...
        <div>
            ...
            <a href="{{ route('partner.offres') }}" class="btn-back animate-fade-up">
        ...
        {{-- Form --}}
        <form action="{{ route('partner.offres.store') }}" method="POST" enctype="multipart/form-data" class="form-card">
            @csrf
            
            <div class="form-group">
                <label class="form-label">Titre de l'offre</label>
                <input type="text" name="titre" class="form-input" placeholder="Ex: Développeur Full Stack" required>
            </div>
            
            <div class="form-group">
                <label class="form-label">Description</label>
                <textarea name="description" rows="5" class="form-textarea" placeholder="Décrivez le poste, les missions, le profil recherché..."></textarea>
            </div>
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" name="localisation" class="form-input" placeholder="Paris, Lyon, Télétravail...">
                </div>
            ...
            <div class="button-group">
                <a href="{{ route('partner.offres') }}" class="btn-secondary">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
